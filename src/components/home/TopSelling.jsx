...
const TopSelling = () => {
    ...
    const products = [
        { id: 1, img: card_1, alt: "topsellingcardoneimg" },
        { id: 2, img: card_2, alt: "topsellingcardtwoimg" },
        { id: 3, img: card_3, alt: "topsellingcardthreeimg" },
        { id: 4, img: card_4, alt: "topsellingcardfourimg" },
        { id: 5, img: card_5, alt: "topsellingcardfiveimg" },
        { id: 6, img: card_5, alt: "topsellingcardsiximg" },
        { id: 7, img: card_5, alt: "topsellingcardsiximg" },
        { id: 8, img: card_5, alt: "topsellingcardsiximg" },
    ];
    ...
    // Wrap your card content with Link component
    // Option 2: Using navigate function on click
            ...
            <div className="container-fluid" id="top-selling">
                ...
                >
                    {products.map((product, index) => (
                        // Option 1: Using Link component
                        // <Link to={`/singleproduct/${product.id}`} className="product-card mt-0" key={index} style={{ textDecoration: 'none' }}>
                        
                        // Option 2: Using onClick with navigate
                        <div 
                        ...
                        {/* </Link> */} {/* Close tag for Option 1 */}
                        </div> // Close tag for Option 2
                    ))}
                </div>
            </div>
        </section>
